...
To follow along with the workshop start by signing up for a [free Cloud account](https://ibm.biz/BdqQ4s). After filling in the form, you will receive a verification code by email, so please use a real address.
